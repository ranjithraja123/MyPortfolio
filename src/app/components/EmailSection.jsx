    ...
    <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4'>
      <div>
        ...
        <p className='text-[#ADB7BE] mb-4 max-w-md'>
          ...
          Whether you have a question or just want to say hi, I&rsquo;ll try my best to get back to you!
        </p>
      ...
      <div>
        <form className='flex flex-col gap-4'>
          ...
          <div className='mb-6'>
            ...
            <textarea name='message' id='message' className='bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5' placeholder='Let&rsquo;s talk about ...' />
          </div>
